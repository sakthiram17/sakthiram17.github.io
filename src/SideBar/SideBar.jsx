...
const SideBar = (props)=>{
    ...
    const nav = (
        ...
        <ul>
        <li className ='close-icon' onClick = {props.close}>
            <FontAwesomeIcon icon = {faClose}></FontAwesomeIcon>
        </li>
        {navList}
        
        <a className = 'NavbarElementAlt center-icon' href = "https://drive.google.com/file/d/1Cj24gLhYx-vLVJeIt8hQ5k4Xj69R23_g/view?usp=sharing">
